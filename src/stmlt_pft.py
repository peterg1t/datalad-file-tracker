...
#         """! This function will iteratively scan for the parent of a
#         file object and update the file track
...
#         # now that we have all the datasets in one list lets find
#         all the commits that were generated by datalad run
...
#     )  # given a filename and a search option we decide to search for
#        # all parents or all childs to fill the file track list
#     # profiler.enable()
#     file_track.search()
#     # profiler.disable()
...
#     # help="display type (Process/Simple)", choices=['Process', 'Simple'])
